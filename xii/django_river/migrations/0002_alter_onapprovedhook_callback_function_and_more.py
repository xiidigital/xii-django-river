...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_hooks', to='xii_django_river.function', verbose_name='Function'),
        ),
        migrations.AlterField(
            model_name='onapprovedhook',
            name='hook_type',
        ...
        migrations.AlterField(
            model_name='onapprovedhook',
            name='workflow',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_hooks', to='xii_django_river.workflow', verbose_name='Workflow'),
        ),
        migrations.AlterField(
