...
from xii.django_river.models.managers.transitionapprovalmeta import TransitionApprovalMetadataManager
from xii.django_river.models.transitionmeta import TransitionMeta
...
def pre_delete_model(sender, instance, *args, **kwargs):
    from xii.django_river.models.transitionapproval import PENDING
