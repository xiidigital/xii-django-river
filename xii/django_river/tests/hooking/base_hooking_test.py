...
from xii.django_river.models import Function, OnTransitHook, OnApprovedHook, OnCompleteHook
...
callback_method = """
from xii.django_river.tests.hooking.base_hooking_test import callback_output
def handle(context):
    print(context)
    key = '%s'
