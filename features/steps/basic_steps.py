...
def state_with_label(context, state_label):
    from xii.django_river.models.factories import StateObjectFactory
...
def transition(context, source_state_label, destination_state_label, workflow_identifier):
    ...
    from xii.django_river.models.factories import TransitionMetaFactory
    from xii.django_river.tests.models import BasicTestModel
    from xii.django_river.models.factories import WorkflowFactory
